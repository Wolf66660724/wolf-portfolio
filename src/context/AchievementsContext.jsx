...
export const ACHIEVEMENTS = {
    ...
    studio_interact: { id: 'studio_interact', label: '拖拽旋转浏览', title: '导演' },
    gallery_inspect: { id: 'gallery_inspect', label: '点击项目查看', title: '艺术评论家' },
    contact_choose: { id: 'contact_choose', label: '找到联系方式', title: '社交达人' }
};
...
export const AchievementsProvider = ({ children }) => {
    ...
    const [completed, setCompleted] = useState(() => {
        try {
            const saved = localStorage.getItem('wolf_achievements');
            if (saved) {
    ...
    useEffect(() => {
        ...
        localStorage.setItem('wolf_achievements', JSON.stringify(toSave));
    }, [completed]);
