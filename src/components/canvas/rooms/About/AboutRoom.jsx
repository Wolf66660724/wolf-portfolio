...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'WOLF', subtitle: '< full-stack security dev />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'HIGHLIGHTS', subtitle: 'Full-Stack - Pentest - Security Ops' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'From self-taught learner to security engineer' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Pentest - Web Dev - Linux - Embedded' },
];
