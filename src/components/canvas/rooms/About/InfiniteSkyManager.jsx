...
const BALLOON_CONFIG = [
    ...
    { texture: '/textures/about/wolfballoon_pentest.webp', paintedTexture: '/textures/about/wolfballoon_pentest_painted.webp', label: 'PENTEST', size: 'large', x: -2.5, y: 2, z: 0.3, phase: 0 },
    { texture: '/textures/about/wolfballoon_security.webp', paintedTexture: '/textures/about/wolfballoon_security_painted.webp', label: 'SECURITY', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/wolfballoon_webdev.webp', paintedTexture: '/textures/about/wolfballoon_webdev_painted.webp', label: 'WEB DEV', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - scattered around
    { texture: '/textures/about/wolfballoon_linux.webp', paintedTexture: '/textures/about/wolfballoon_linux_painted.webp', label: 'LINUX', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/textures/about/wolfballoon_python.webp', paintedTexture: '/textures/about/wolfballoon_python_painted.webp', label: 'PYTHON', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/textures/about/wolfballoon_embedded.webp', paintedTexture: '/textures/about/wolfballoon_embedded_painted.webp', label: 'EMBEDDED', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - background accents
    { texture: '/textures/about/wolfballoon_db.webp', paintedTexture: '/textures/about/wolfballoon_db_painted.webp', label: 'DATABASE', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    { texture: '/textures/about/wolfballoon_ai.webp', paintedTexture: '/textures/about/wolfballoon_ai_painted.webp', label: 'AI SEC', size: 'small', x: 5.5, y: 3, z: -0.7, phase: 2.8 },
    { texture: '/textures/about/wolfballoon_network.webp', paintedTexture: '/textures/about/wolfballoon_network_painted.webp', label: 'NETWORK', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/wolfballoon_blog.webp', paintedTexture: '/textures/about/wolfballoon_blog_painted.webp', label: 'BLOG', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
...
const SkillBalloon = ({ config, revealFactorRef, spreadFactorRef, timeRef }) => {
    ...
    const legacyAspects = {
        ...
        'wolfballoon_pentest.webp': 512 / 1024,
        'wolfballoon_security.webp': 512 / 1024,
        'wolfballoon_webdev.webp': 512 / 1024,
        'wolfballoon_linux.webp': 512 / 1024,
        'wolfballoon_python.webp': 512 / 1024,
        'wolfballoon_embedded.webp': 512 / 1024,
        'wolfballoon_db.webp': 512 / 1024,
        'wolfballoon_ai.webp': 512 / 1024,
        'wolfballoon_network.webp': 512 / 1024,
        'wolfballoon_blog.webp': 512 / 1024,
    };
