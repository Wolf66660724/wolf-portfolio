...
const FALLBACK_PROJECTS = [
    ...
    },
    {
        ...
        front: '/textures/gallery/toolkit_front.webp',
        painted: '/textures/gallery/toolkit_painted.webp',
        url: 'https://github.com/Wolf66660724',
        description: 'Security automation scripts in Python & Shell for recon, batch verification, and information gathering - built to speed up penetration testing workflows.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/phplogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'blog',
        title: 'WOLF BLOG',
