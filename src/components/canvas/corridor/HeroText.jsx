...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ITOM split effect
        ...
        { char: 'W', baseX: -0.98, splitDir: -1.6, delay: 0 },
        { char: 'O', baseX: -0.32, splitDir: -0.6, delay: 0 },
        { char: 'L', baseX: 0.3, splitDir: 0.6, delay: 0 },
        { char: 'F', baseX: 0.92, splitDir: 1.8, delay: 0 },
    ], []);

    // Tagline words for split effect
        const taglineWords = useMemo(() => [
        { text: '<', baseX: -1.0, splitDir: -1.5, delay: 0 },
        { text: 'full-stack', baseX: -0.45, splitDir: -0.8, delay: 0 },
        { text: 'security', baseX: 0.45, splitDir: 0.8, delay: 0 },
        { text: '/>', baseX: 1.0, splitDir: 1.5, delay: 0 },
    ], []);
