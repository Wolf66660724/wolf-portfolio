...
const CorridorDecorations = ({ segmentLength, zOffset, corridorWidth = 4, corridorHeight = 3.5, zClip = 100000, setCameraOverride }) => {
    ...
    // - y: pozycja Y (wysokość na ścianie, 0 = środek)
        const frames = useMemo(() => [
        {
            ...
            y: 0.3,
            id: 'frame-1',
            image: '/textures/corridor/wall-photo-1.webp',
            imagePainted: '/textures/corridor/wall-photo-1_color.webp',
            imageWidth: 0.9,
            imageHeight: 1.5,
            offsetFromWall: 0.1,
        },
        {
            ...
            y: 0.2,
            id: 'frame-2',
            image: '/textures/corridor/wall-photo-2.webp',
            imagePainted: '/textures/corridor/wall-photo-2_color.webp',
            imageWidth: 0.9,
            imageHeight: 1.38,
            offsetFromWall: 0.1
        },
        {
            ...
            y: 0.25,
            id: 'frame-3',
            image: '/textures/corridor/wall-photo-3.webp',
            imagePainted: '/textures/corridor/wall-photo-3_color.webp',
            imageWidth: 0.9,
            imageHeight: 0.9,
        },
        {
            ...
            y: 0.35,
            id: 'frame-4',
            image: '/textures/corridor/wall-photo-4.webp',
            imagePainted: '/textures/corridor/wall-photo-4_color.webp',
            imageWidth: 0.9,
            imageHeight: 1.14,
        },
    ], [zOffset]);
