...
function buildLlmsTxt(globalInfo, projects, studio, awards, faqList) {
    ...
    const siteDescription = globalInfo?.siteDescription || 'Interactive 3D Resume & Portfolio by Wolf (茶狼)';
    const aboutMe = globalInfo?.aboutMe || 'I am a full-stack developer and security engineer specializing in penetration testing, security operations, and web development.';
    ...
    async function getLlmsContent() {
        if (!cachedLlmsContent) {
            try {
                ...
                cachedLlmsContent = `# Wolf (茶狼)\n> Full-Stack Developer · Pentester · Security Engineer\n`;
            }
        }
